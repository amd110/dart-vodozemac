...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1368672084;
...
fn wire__crate__bindings__vodozemac_aes_256_ctr_finalize_impl(
    that: impl CstDecode<crate::bindings::VodozemacAes256Ctr>,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "vodozemac_aes_256_ctr_finalize",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                let output_ok = Result::<_, ()>::Ok({
                    crate::bindings::VodozemacAes256Ctr::finalize(&api_that);
                })?;
                Ok(output_ok)
            })())
        },
...
fn wire__crate__bindings__vodozemac_aes_256_ctr_new_impl(
    key: impl CstDecode<Vec<u8>>,
    iv: impl CstDecode<Vec<u8>>,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "vodozemac_aes_256_ctr_new",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok = crate::bindings::VodozemacAes256Ctr::new(&api_key, &api_iv)?;
                    Ok(output_ok)
                })(),
            )
        },
...
fn wire__crate__bindings__vodozemac_aes_256_ctr_update_impl(
    that: impl CstDecode<crate::bindings::VodozemacAes256Ctr>,
    chunk: impl CstDecode<Vec<u8>>,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "vodozemac_aes_256_ctr_update",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            let api_that = that.cst_decode();
            let api_chunk = chunk.cst_decode();
            transform_result_dco::<_, _, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::bindings::VodozemacAes256Ctr::update(
                    &api_that, api_chunk,
                ))?;
                Ok(output_ok)
            })())
...
impl SseDecode for RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <usize>::sse_decode(deserializer);
        return unsafe { decode_rust_opaque_nom(inner) };
...
impl SseDecode for crate::bindings::VodozemacAes256Ctr {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_cipher =
            <RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>>>::sse_decode(deserializer);
        return crate::bindings::VodozemacAes256Ctr { cipher: var_cipher };
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::bindings::VodozemacAes256Ctr {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [self.cipher.into_into_dart().into_dart()].into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::bindings::VodozemacAes256Ctr
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::bindings::VodozemacAes256Ctr>
    for crate::bindings::VodozemacAes256Ctr
{
    fn into_into_dart(self) -> crate::bindings::VodozemacAes256Ctr {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        let (ptr, size) = self.sse_encode_raw();
        <usize>::sse_encode(ptr, serializer);
...
impl SseEncode for crate::bindings::VodozemacAes256Ctr {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>>>::sse_encode(self.cipher, serializer);
    }
}
...
mod io {
    ...
    impl CstDecode<RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>>> for usize {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>> {
            unsafe { decode_rust_opaque_nom(self as _) }
        }
    }
    impl
    ...
    impl CstDecode<crate::bindings::VodozemacAes256Ctr> for *mut wire_cst_vodozemac_aes_256_ctr {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> crate::bindings::VodozemacAes256Ctr {
            let wrap = unsafe { flutter_rust_bridge::for_generated::box_from_leak_ptr(self) };
            CstDecode::<crate::bindings::VodozemacAes256Ctr>::cst_decode(*wrap).into()
        }
    }
    ...
    impl CstDecode<crate::bindings::VodozemacAes256Ctr> for wire_cst_vodozemac_aes_256_ctr {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> crate::bindings::VodozemacAes256Ctr {
            crate::bindings::VodozemacAes256Ctr {
                cipher: self.cipher.cst_decode(),
            }
        }
    }
    impl CstDecode<crate::bindings::VodozemacCurve25519PublicKey>
    ...
    impl NewWithNullPtr for wire_cst_vodozemac_aes_256_ctr {
        fn new_with_null_ptr() -> Self {
            Self {
    ...
    impl Default for wire_cst_vodozemac_aes_256_ctr {
        fn default() -> Self {
            Self::new_with_null_ptr()
        }
    }
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_vodozemac_wire__crate__bindings__vodozemac_aes_256_ctr_finalize(
        that: *mut wire_cst_vodozemac_aes_256_ctr,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__bindings__vodozemac_aes_256_ctr_finalize_impl(that)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_vodozemac_wire__crate__bindings__vodozemac_aes_256_ctr_new(
        key: *mut wire_cst_list_prim_u_8_loose,
        iv: *mut wire_cst_list_prim_u_8_loose,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__bindings__vodozemac_aes_256_ctr_new_impl(key, iv)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_vodozemac_wire__crate__bindings__vodozemac_aes_256_ctr_update(
        that: *mut wire_cst_vodozemac_aes_256_ctr,
        chunk: *mut wire_cst_list_prim_u_8_loose,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__bindings__vodozemac_aes_256_ctr_update_impl(that, chunk)
    }
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_vodozemac_rust_arc_increment_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(
        ptr: *const std::ffi::c_void,
    ) {
        unsafe {
            StdArc::<RwLock<ctr::Ctr64BE<aes::Aes256>>>::increment_strong_count(ptr as _);
        }
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_vodozemac_rust_arc_decrement_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(
        ptr: *const std::ffi::c_void,
    ) {
        unsafe {
            StdArc::<RwLock<ctr::Ctr64BE<aes::Aes256>>>::decrement_strong_count(ptr as _);
        }
    }
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_vodozemac_cst_new_box_autoadd_vodozemac_aes_256_ctr(
    ) -> *mut wire_cst_vodozemac_aes_256_ctr {
        flutter_rust_bridge::for_generated::new_leak_box_ptr(
            wire_cst_vodozemac_aes_256_ctr::new_with_null_ptr(),
        )
    }
    ...
    #[repr(C)]
    #[derive(Clone, Copy)]
    pub struct wire_cst_vodozemac_aes_256_ctr {
        cipher: usize,
    }
    #[repr(C)]
    #[derive(Clone, Copy)]
...
mod web {
    ...
    impl CstDecode<crate::bindings::VodozemacAes256Ctr>
        for flutter_rust_bridge::for_generated::wasm_bindgen::JsValue
    {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> crate::bindings::VodozemacAes256Ctr {
    ...
    impl CstDecode<RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>>>
        for flutter_rust_bridge::for_generated::wasm_bindgen::JsValue
    {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> RustOpaqueNom<RwLock<ctr::Ctr64BE<aes::Aes256>>> {
    ...
    #[wasm_bindgen]
    pub fn wire__crate__bindings__vodozemac_aes_256_ctr_finalize(
        that: flutter_rust_bridge::for_generated::wasm_bindgen::JsValue,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__bindings__vodozemac_aes_256_ctr_finalize_impl(that)
    }
    ...
    #[wasm_bindgen]
    pub fn wire__crate__bindings__vodozemac_aes_256_ctr_new(
        key: Box<[u8]>,
        iv: Box<[u8]>,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__bindings__vodozemac_aes_256_ctr_new_impl(key, iv)
    ...
    #[wasm_bindgen]
    pub fn wire__crate__bindings__vodozemac_aes_256_ctr_update(
        that: flutter_rust_bridge::for_generated::wasm_bindgen::JsValue,
        chunk: Box<[u8]>,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__bindings__vodozemac_aes_256_ctr_update_impl(that, chunk)
    ...
    #[wasm_bindgen]
    pub fn rust_arc_increment_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(
        ptr: *const std::ffi::c_void,
    ) {
        unsafe {
            StdArc::<RwLock<ctr::Ctr64BE<aes::Aes256>>>::increment_strong_count(ptr as _);
    ...
    #[wasm_bindgen]
    pub fn rust_arc_decrement_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(
        ptr: *const std::ffi::c_void,
    ) {
        unsafe {
            StdArc::<RwLock<ctr::Ctr64BE<aes::Aes256>>>::decrement_strong_count(ptr as _);
