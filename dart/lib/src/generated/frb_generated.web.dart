...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  JSAny cst_encode_box_autoadd_vodozemac_aes_256_ctr(VodozemacAes256Ctr raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return cst_encode_vodozemac_aes_256_ctr(raw);
  }
  ...
  @protected
  JSAny cst_encode_vodozemac_aes_256_ctr(VodozemacAes256Ctr raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [cst_encode_RustOpaque_RwLockctrCtr64BEaesAes256(raw.cipher)].jsify()!;
  }
...
class RustLibWire implements BaseWire {
  ...
  JSAny? /* flutter_rust_bridge::for_generated::WireSyncRust2DartDco */
      wire__crate__bindings__vodozemac_aes_256_ctr_finalize(JSAny that) =>
          wasmModule.wire__crate__bindings__vodozemac_aes_256_ctr_finalize(that);

  JSAny? /* flutter_rust_bridge::for_generated::WireSyncRust2DartDco */
      wire__crate__bindings__vodozemac_aes_256_ctr_new(JSAny key, JSAny iv) =>
          wasmModule.wire__crate__bindings__vodozemac_aes_256_ctr_new(key, iv);

  JSAny? /* flutter_rust_bridge::for_generated::WireSyncRust2DartDco */
      wire__crate__bindings__vodozemac_aes_256_ctr_update(JSAny that, JSAny chunk) =>
          wasmModule.wire__crate__bindings__vodozemac_aes_256_ctr_update(that, chunk);
  ...
  void rust_arc_increment_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(int ptr) =>
      wasmModule.rust_arc_increment_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(ptr);

  void rust_arc_decrement_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(int ptr) =>
      wasmModule.rust_arc_decrement_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(ptr);
...
extension type RustLibWasmModule._(JSObject _) implements JSObject {
  ...
  external void rust_arc_increment_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(int ptr);

  external void rust_arc_decrement_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256(int ptr);
