...
// Rust type: RustOpaqueNom<RwLock < ctr :: Ctr64BE < aes :: Aes256 > >>
abstract class RwLockCtr64BeAes256 implements RustOpaqueInterface {}
...
class VodozemacAes256Ctr {
  final RwLockCtr64BeAes256 cipher;

  const VodozemacAes256Ctr.raw({
    required this.cipher,
  });

  void finalize() => RustLib.instance.api.crateBindingsVodozemacAes256CtrFinalize(
        that: this,
      );

  factory VodozemacAes256Ctr({required List<int> key, required List<int> iv}) =>
      RustLib.instance.api.crateBindingsVodozemacAes256CtrNew(key: key, iv: iv);

  Uint8List update({required List<int> chunk}) =>
      RustLib.instance.api.crateBindingsVodozemacAes256CtrUpdate(that: this, chunk: chunk);

  @override
  int get hashCode => cipher.hashCode;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is VodozemacAes256Ctr && runtimeType == other.runtimeType && cipher == other.cipher;
}
