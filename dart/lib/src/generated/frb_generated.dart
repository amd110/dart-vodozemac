...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1368672084;
...
abstract class RustLibApi extends BaseApi {
  ...
  void crateBindingsVodozemacAes256CtrFinalize({required VodozemacAes256Ctr that});

  VodozemacAes256Ctr crateBindingsVodozemacAes256CtrNew({required List<int> key, required List<int> iv});

  Uint8List crateBindingsVodozemacAes256CtrUpdate({required VodozemacAes256Ctr that, required List<int> chunk});
  ...
  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_RwLockCtr64BeAes256;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_RwLockCtr64BeAes256;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void crateBindingsVodozemacAes256CtrFinalize({required VodozemacAes256Ctr that}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_box_autoadd_vodozemac_aes_256_ctr(that);
        return wire.wire__crate__bindings__vodozemac_aes_256_ctr_finalize(arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_unit,
        decodeErrorData: null,
      ),
      constMeta: kCrateBindingsVodozemacAes256CtrFinalizeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBindingsVodozemacAes256CtrFinalizeConstMeta => const TaskConstMeta(
        debugName: "vodozemac_aes_256_ctr_finalize",
        argNames: ["that"],
      );
  ...
  VodozemacAes256Ctr crateBindingsVodozemacAes256CtrNew({required List<int> key, required List<int> iv}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_list_prim_u_8_loose(key);
        var arg1 = cst_encode_list_prim_u_8_loose(iv);
        return wire.wire__crate__bindings__vodozemac_aes_256_ctr_new(arg0, arg1);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_vodozemac_aes_256_ctr,
        decodeErrorData: dco_decode_AnyhowException,
      ),
      constMeta: kCrateBindingsVodozemacAes256CtrNewConstMeta,
      argValues: [key, iv],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBindingsVodozemacAes256CtrNewConstMeta => const TaskConstMeta(
        debugName: "vodozemac_aes_256_ctr_new",
        argNames: ["key", "iv"],
      );
  ...
  Uint8List crateBindingsVodozemacAes256CtrUpdate({required VodozemacAes256Ctr that, required List<int> chunk}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_box_autoadd_vodozemac_aes_256_ctr(that);
        var arg1 = cst_encode_list_prim_u_8_loose(chunk);
        return wire.wire__crate__bindings__vodozemac_aes_256_ctr_update(arg0, arg1);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_list_prim_u_8_strict,
        decodeErrorData: null,
      ),
      constMeta: kCrateBindingsVodozemacAes256CtrUpdateConstMeta,
      argValues: [that, chunk],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateBindingsVodozemacAes256CtrUpdateConstMeta => const TaskConstMeta(
        debugName: "vodozemac_aes_256_ctr_update",
        argNames: ["that", "chunk"],
      );
  ...
  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_RwLockCtr64BeAes256 =>
      wire.rust_arc_increment_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_RwLockCtr64BeAes256 =>
      wire.rust_arc_decrement_strong_count_RustOpaque_RwLockctrCtr64BEaesAes256;
  ...
  RwLockCtr64BeAes256 dco_decode_RustOpaque_RwLockctrCtr64BEaesAes256(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return RwLockCtr64BeAes256Impl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  VodozemacAes256Ctr dco_decode_box_autoadd_vodozemac_aes_256_ctr(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_vodozemac_aes_256_ctr(raw);
  }
  ...
  VodozemacAes256Ctr dco_decode_vodozemac_aes_256_ctr(dynamic raw) {
    ...
    final arr = raw as List<dynamic>;
    if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return VodozemacAes256Ctr.raw(
      cipher: dco_decode_RustOpaque_RwLockctrCtr64BEaesAes256(arr[0]),
    );
  }
  ...
  RwLockCtr64BeAes256 sse_decode_RustOpaque_RwLockctrCtr64BEaesAes256(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return RwLockCtr64BeAes256Impl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  VodozemacAes256Ctr sse_decode_box_autoadd_vodozemac_aes_256_ctr(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_vodozemac_aes_256_ctr(deserializer));
  }
  ...
  VodozemacAes256Ctr sse_decode_vodozemac_aes_256_ctr(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_cipher = sse_decode_RustOpaque_RwLockctrCtr64BEaesAes256(deserializer);
    return VodozemacAes256Ctr.raw(cipher: var_cipher);
  }
...
// ignore: invalid_use_of_internal_member
  ...
  int cst_encode_RustOpaque_RwLockctrCtr64BEaesAes256(RwLockCtr64BeAes256 raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
// ignore: invalid_use_of_internal_member
    return (raw as RwLockCtr64BeAes256Impl).frbInternalCstEncode();
  }
...
// ignore: invalid_use_of_internal_member
  ...
  void sse_encode_RustOpaque_RwLockctrCtr64BEaesAes256(RwLockCtr64BeAes256 self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as RwLockCtr64BeAes256Impl).frbInternalSseEncode(move: null), serializer);
  }
  ...
  void sse_encode_box_autoadd_vodozemac_aes_256_ctr(VodozemacAes256Ctr self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_vodozemac_aes_256_ctr(self, serializer);
  }
  ...
  void sse_encode_vodozemac_aes_256_ctr(VodozemacAes256Ctr self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_RustOpaque_RwLockctrCtr64BEaesAes256(self.cipher, serializer);
  }
...
@sealed
class RwLockCtr64BeAes256Impl extends RustOpaque implements RwLockCtr64BeAes256 {
  // Not to be used by end users
  RwLockCtr64BeAes256Impl.frbInternalDcoDecode(List<dynamic> wire) : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  RwLockCtr64BeAes256Impl.frbInternalSseDecode(BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib.instance.api.rust_arc_increment_strong_count_RwLockCtr64BeAes256,
    rustArcDecrementStrongCount: RustLib.instance.api.rust_arc_decrement_strong_count_RwLockCtr64BeAes256,
    rustArcDecrementStrongCountPtr: RustLib.instance.api.rust_arc_decrement_strong_count_RwLockCtr64BeAes256Ptr,
  );
}
